...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <a class="btn btn-default checkTop" href="checkDisplay.php?letter=<? echo $_GET['letter']; ?>" role="button">Already Checked In</a>
	...
	<?php include_once("includes/connection.php"); ?>	
			...
			$sql="SELECT * FROM $tbl_name WHERE checkIn='No' AND lastName LIKE '$letter%'" ;
		...
		<table class="table table-striped">
		  ...
		  <tbody>
			...
			<tr>
			  ...
			  <td>
				<a class="btn btn-default" href="update_yes.php?checkIn=Yes&KeyID=<? echo $rows['KeyID']; ?>" role="button">Check In</a>			  
			  </td>
